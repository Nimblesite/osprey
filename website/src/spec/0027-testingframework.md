...
> shared core exactly like every other built-in ([0012](/spec/0012-built-infunctions/)):
...
- [0012 Built-In Functions](/spec/0012-built-infunctions/) — the built-in
  reference (testing built-ins listed there, normative rules here).
- [0023 Language Flavors](/spec/0023-languageflavors/) — flavor selection and
  the shared-core boundary the built-ins sit above.
- [0024 ML Flavor Syntax](/spec/0024-mlflavorsyntax/) — the ML surface used in
