...
#
# Natively all 215 programs are covered by golden files, most shared by a
...
# 149. On the mobile C ABI targets the same accounting leaves 134: the rest are
...
case $TARGET in
  wasm32)            GOLDEN_MIN=${OSPREY_GOLDEN_MIN:-149} ;;
  ios-sim|android*) GOLDEN_MIN=${OSPREY_GOLDEN_MIN:-134} ;;
  *)                 GOLDEN_MIN=${OSPREY_GOLDEN_MIN:-215} ;;
esac
